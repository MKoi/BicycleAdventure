...
void Direct3DBase::CreateWindowSizeDependentResources()
{
	...
	swapChainDesc.Width = static_cast<UINT>(m_windowBounds.Width);//m_renderTargetSize.Width); // Match the size of the window.
	swapChainDesc.Height = static_cast<UINT>(m_windowBounds.Height);//m_renderTargetSize.Height);
	...
	CD3D11_TEXTURE2D_DESC depthStencilDesc(
		...
		static_cast<UINT>(m_windowBounds.Width),//m_renderTargetSize.Width),
		static_cast<UINT>(m_windowBounds.Height),//m_renderTargetSize.Height),
		1,
		1,
...
{
	if (m_swapChain == nullptr || m_renderTargetView == nullptr || m_depthStencilView == nullptr)
	{
		return;
	}
