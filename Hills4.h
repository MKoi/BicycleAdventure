...
class Hills4 : public GameArea
{
public:

	Hills4(b2World* world, const b2Vec2& pos, const Theme* theme, int variant) : GameArea(world, pos, theme, variant)
	{
		...
		case 4:
			...
			controlPoints.emplace_back(20.0f, 6.0f);
			controlPoints.emplace_back(20.0f, -10.0f);
		...
		case 6:
			...
			controlPoints.emplace_back(20.0f, 7.0f);
			controlPoints.emplace_back(30.0f, 10.0f);
			controlPoints.emplace_back(10.0f, -7.0f);
			controlPoints.emplace_back(20.0f, -10.0f);
			controlPoints.emplace_back(30.0f, -10.0f);
			break;
		default:
